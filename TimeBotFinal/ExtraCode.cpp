...
//this will take and swap the integers values through pointers
void numberOfTimesRun(int*const pnumberOfTimesRunOne, int*const pnumberOfTimesRunTwo)
{
	int temp = *pnumberOfTimesRunOne;
	*pnumberOfTimesRunOne = *pnumberOfTimesRunTwo;
	*pnumberOfTimesRunTwo = temp;
}
